...
$env:GOOGLE_APPLICATION_CREDENTIALS='./keys/firebase-sa.json'; \
# set the admin email you want to create (defaults to snapspacelite@gmail.com if omitted)
...
```powershell
$env:GOOGLE_APPLICATION_CREDENTIALS='./keys/firebase-sa.json'; \
node .\scripts\create_admin_user.mjs snapspacelite@gmail.com adminku290925
```
...
```powershell
$env:GOOGLE_APPLICATION_CREDENTIALS='./keys/firebase-sa.json'; $env:ADMIN_EMAIL='snapspacelite@gmail.com'; node .\scripts\set_system_admin_claim.mjs
```
...
```powershell
$env:GOOGLE_APPLICATION_CREDENTIALS='./keys/firebase-sa.json'; node .\scripts\verify_admin.mjs snapspacelite@gmail.com
```
